...
&& isset($_POST['name'])&& isset($_POST['password'])&& isset($_POST['number'])&& isset($_POST['address']) && isset($_POST['follow']) && isset($_POST['gendor']) && isset($_POST['terms']) && isset($_POST['collect'])) {
